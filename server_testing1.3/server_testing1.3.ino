...
void SendSensorData() {
  ...
  String temp,humidity,corbonmono,sensorData4,sensorData5,sensorData6,sensorData7, postData,noise,light;
  temp=t;
    humidity=h;
...
//              sensorData7="High";
  //Post Data
  postData = "temp=" +  temp + "&humidity=" + humidity + "&corbonmono=" + corbonmono + "&sound=" + noise + "&light=" + light;
  
  http.begin("http://192.168.8.101/esp8266db/postData.php");              //change the ip to your computer ip address
